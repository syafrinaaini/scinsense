...
class OTPFailed extends StatefulWidget {
  @override
  _OTPFailedState createState() => _OTPFailedState();
}

class _OTPFailedState extends State<OTPFailed> with SingleTickerProviderStateMixin {
